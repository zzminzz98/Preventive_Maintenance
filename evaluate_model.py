...
def evaluate_model():
    try:
        ...
        # 2.Transform dataset for evaluation
        logger.info("Extract last recorded cycle for each test engine unit")
        ...
        # 3. Define features X_test and true target y_true
        logger.info("="*100)
        ...
        # 4. Load training model artifact
        logger.info("="*100)
